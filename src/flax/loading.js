(function () {
    ...
    (function () {
        ...
        startAnimation(list, function () {
            var div = document.getElementById("flaxLoading");
            if (!div) {
