...
function PixiTextInput(text, style) {
    ...
    this.localHeight = this.textField.determineFontProperties(style.font).fontSize
                     + this.textField.style.strokeThickness;
    this.backgroundGraphics = new flax.Graphics();
    this.textFieldMask = new flax.Graphics();
    this.caret = new flax.Graphics();
    this.drawElements();
...
PixiTextInput.prototype.drawElements = function() {
    ...
    this.caret.drawRect(this.localHeight*0.1, this.localHeight*0.1, 1, this.localHeight*0.8);
    this.caret.endFill();
}
